...
public class Processing_IMU_Tractor_Demo_1440x900 extends PApplet {
...
public void draw() {
  ...
  pushMatrix(); // Built-in function that saves the current position of the coordinate system
    ...
    pushMatrix();
      translate(width/4.35f, height/2.0f); // (1600x900)(width/5.7, height/2.0); (1280x800)(width/4.15, height/1.8);
...
public void pitchScale() { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Processing_IMU_Tractor_Demo_1440x900" };
    if (passedArgs != null) {
